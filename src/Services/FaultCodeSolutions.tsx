...
const FaultCodeSolutions = () => {
    ...
    const fetchSolutionData = async (
        ...
        console.log('🔍 fetchSolutionData called with:', { targetPage, searchDtc, searchMake, searchGeneric });
        ...
        try {
            ...
            if (result && Array.isArray(result.data)) {
                ...
                if (result.data.length === 0) {
                    setError(searchDtc || searchMake || searchGeneric !== "" 
                        ? "No solutions found for the specified criteria." 
            ...
            setSolutionData([]);
            setTotal(0);
            setError("Failed to fetch fault code solutions. Please try again.");
        } finally {
            setLoading(false);
            abortControllerRef.current = null;
            console.log('✨ fetchSolutionData completed');
        }
    };
                ...
                {loading ? (
                    <div className="flex items-center justify-center py-20">
                        <div className="text-center">
                            ...
                            <p className="text-green-500 text-xl">Loading solutions...</p>
                                ...
                                <tbody>
                                    {solutionData.map((item:any, idx) => (
                                        <tr key={item.id || idx} className="hover:bg-gray-50">
                                            ...
                                            <td className="border px-3 py-2 font-mono font-semibold text-green-600">
                                                {item.dtc || "-"}
                                            </td>
                    ...
                    <div className="text-center py-20">
                        <p className="text-gray-500 text-xl">No solution data to display</p>
            ...
            {total > 0 && (
                <div className="text-center text-sm text-gray-500 mt-2 bg-white rounded-lg p-4 border">
                    <div className="flex flex-wrap justify-center items-center gap-6">
                        ...
                        <span>🔧 Current Page Items: {solutionData.length}</span>
                    </div>
                </div>
            )}
        </div>
