...
// // import Sidebar from './Sidebar'; // assuming Sidebar is in the same directory or adjust the path
...
//             <p>No users found.</p>
//           ) : (
//             <table className="min-w-max w-full border-collapse text-sm border border-gray-300">
//               <thead className="bg-gray-100">
//                 <tr>
//                   {Object.keys(users[0]).map((key) => (
//                     <th key={key} className="border px-4 py-2 text-left whitespace-nowrap">
//                       {key}
//                     </th>
//                   ))}
//                 </tr>
